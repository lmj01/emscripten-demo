...
function Wa(a) {
 ...
 a = c[153] | 0;
 if ((a | 0) != 0 ? (t = c[151] | 0, y = t + l | 0, y >>> 0 <= t >>> 0 | y >>> 0 > a >>> 0) : 0) {
  M = 0;
  return M | 0;
 }
 d : do if (!(c[154] & 4)) {
  ...
  f : do if ((v | 0) == 184) {
   g = 0 - d | 0;
   do if (j >>> 0 > d >>> 0 & (d >>> 0 < 2147483647 & (f | 0) != (-1 | 0)) ? (u = c[163] | 0, u = k - d + u & 0 - u, u >>> 0 < 2147483647) : 0) if ((ma(u | 0) | 0) == (-1 | 0)) {
    ma(g | 0) | 0;
    break f;
   } else {
    d = u + d | 0;
...
function Na(a) {
 ...
 do if (a) {
  ...
  if (!(c[13] | 0)) b = 0; else b = Na(c[13] | 0) | 0;
  ia(36);
  a = c[8] | 0;
  if (a) do {
   if ((c[a + 76 >> 2] | 0) > -1) d = Oa(a) | 0; else d = 0;
   if ((c[a + 20 >> 2] | 0) >>> 0 > (c[a + 28 >> 2] | 0) >>> 0) b = Ua(a) | 0 | b;
   if (d) Pa(a);
   a = c[a + 56 >> 2] | 0;
  } while ((a | 0) != 0);
  ra(36);
...
var xa=[cb,Qa];var ya=[db,Ta,Ra,Sa];var za=[eb,Va];return{_malloc:Wa,_free:Xa,_memset:Za,_add:Ja,_memcpy:_a,_fflush:Na,_square:Ka,___errno_location:La,runPostSets:Ya,stackAlloc:Aa,stackSave:Ba,stackRestore:Ca,establishStackSpace:Da,setThrew:Ea,setTempRet0:Ha,getTempRet0:Ia,dynCall_ii:$a,dynCall_iiii:ab,dynCall_vi:bb}})
